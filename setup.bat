...
".venv\Scripts\python.exe" -m pip install flask flask-cors requests playwright PyPDF2
if errorlevel 1 goto :install_fail
...
".venv\Scripts\python.exe" -c "import flask, requests, playwright, PyPDF2; print('All imports OK')"
