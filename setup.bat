...
echo.
echo [3/4] Installing packages (flask, requests, playwright)...
".venv\Scripts\python.exe" -m pip install --upgrade pip
if errorlevel 1 goto :install_fail
".venv\Scripts\python.exe" -m pip install flask flask-cors requests playwright
if errorlevel 1 goto :install_fail
...
".venv\Scripts\python.exe" -c "import flask, requests, playwright; print('All imports OK')"
